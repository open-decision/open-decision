...
export const designSystem = createStitches({
  theme: {
    ...
    shadows: {
      1: "0px 0px 2px $colors$shadowColor",
      2: "0px px 4px $colors$shadowColor",
      3: "0px 0px 6px $colors$shadowColor",
      4: "0px 0px 8px $colors$shadowColor",
      5: "0px 0px 12px $colors$shadowColor",
      6: "0px 0px 16px $colors$shadowColor",
      7: "0px 0px 32px $colors$shadowColor",
