export default {
  ...
  dataProtection: {
    ...
    end: "gelesen und stimme ihr zu.",
  },
  alphaDisclaimer:
    "Ich habe zur Kenntnis genommen, dass sich die Software in einer frühen Entwicklungsphase befindet und ein fehlerfreier Betrieb nicht garantiert werden kann.",
} as const;
